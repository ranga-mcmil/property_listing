...
* @see https://v0.dev/t/jrHYxeCUMN1
    ...
    <div className="min-h-screen bg-gray-100">
      <header className="flex items-center justify-between px-6 py-4 bg-white shadow-md">
        ...
        <div className="relative">
          ...
          <div className="absolute right-0 z-10 hidden w-40 mt-2 bg-white border rounded-md shadow-lg">
            <Link href="#" className="block px-4 py-2 text-gray-800 hover:bg-gray-100" prefetch={false}>
              Signup
            </Link>
            <Link href="#" className="block px-4 py-2 text-gray-800 hover:bg-gray-100" prefetch={false}>
              Login
